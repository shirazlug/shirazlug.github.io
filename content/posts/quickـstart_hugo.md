...
- archtypes : شما می توانید توسط دستور hugo new یک محتوایه جدید ایجاد کنید ، وقتی این دستور اجرا میشود ، هیوگو یک تعداد خواص پیکربندی ( configuration properties ) مانند تاریخ ( date ) و عنوان ( title ) به پست شما اضافه میکند. Archtypes به شما این اجرا را می دهد که خواص پیکربندی دلخواه خود را تعریف کنید تا در زمان ساخت پست جدید ( با دستور hugo new ) آن خواص به صورت خودکار به آن اضافه شود.
