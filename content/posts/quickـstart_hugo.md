...
تم ها یک لایه از الگوها ( templates ) را برای تولید سایت ارایه می کنند. شما می توانید تعداد زیادی تم که به صورت بازمتن وجود دارند را در آدرس https://theme.gohugo.io ببینید و استفاده کنید.
